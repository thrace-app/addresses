...
export class UniswapV2Resolver implements Generator {
  ...
  async resolve() {
    ...
    do {
      ...
      console.log(
        `Fetched Uniswap V2: ${response.pairs.length} (${currentPoolsLength} pools, ${currentTokensLength} tokens) After: ${lastAddress}`
      )
